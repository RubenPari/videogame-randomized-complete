    ...
    <div class="space-y-6">
      ...
      <div class="space-y-2">
        <div class="flex justify-between items-center">
          ...
          <button @click="resetYearRange" class="text-[10px] text-zinc-600 hover:text-cyan-400 uppercase font-bold tracking-wider transition-colors">{{ $t('filters.reset') }}</button>
        </div>
      ...
      <div class="space-y-2">
        ...
        <div class="flex gap-2 pt-1">
          <button @click="selectAllPlatforms" class="flex-1 py-1.5 bg-zinc-950 border border-zinc-800 hover:border-zinc-600 text-zinc-400 hover:text-white text-[10px] font-bold uppercase tracking-wider rounded-lg transition-colors">{{ $t('filters.all') }}</button>
          <button @click="deselectAllPlatforms" class="flex-1 py-1.5 bg-zinc-950 border border-zinc-800 hover:border-zinc-600 text-zinc-400 hover:text-white text-[10px] font-bold uppercase tracking-wider rounded-lg transition-colors">{{ $t('filters.none') }}</button>
        </div>
      </div>
